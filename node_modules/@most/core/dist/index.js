...
var DelaySink = /*#__PURE__*/function (_Pipe) {
  ...
  DelaySink.prototype.event = function event(t, x) {
    this.tasks.push(scheduler.delay(this.dt, propagateEventTask$1(x, this.sink), this.scheduler));
  };

  DelaySink.prototype.end = function end(t) {
    this.tasks.push(scheduler.delay(this.dt, propagateEndTask(this.sink), this.scheduler));
  };
